...
export const createCustomerRecord = async (customerToCreate, database, company, user) => {
	await database.action(async () => {
		const newCustomer = await database.collections.get(Customer.table).create(customer => {
    ...
    <div>
      ...
      <div id="main-area">
        ...
        <div id="main-body">
          ...
          <div id="bottom-area">
            <CreateComponent createRecord={createRecord} createFromExternal={false} />
          </div>
        </div>
      </div>
    </div>
