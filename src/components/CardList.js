...
const CardListItem = (props) => {
	const {entry, company, model, user, createdBy, EditComponent, deleteRecord, updateRecord, keyFieldName, modelName, displayNameField, fieldNames, database} = props;
...
class CardList extends React.Component {
	...
	render() {
		const {entries, EditComponent, deleteRecord, updateRecord, fieldNames, database,
			displayNameField, modelName, model, keyFieldName, search, company, user, users } = this.props;
